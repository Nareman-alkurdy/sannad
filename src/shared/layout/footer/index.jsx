...
//                 <img src="src\assets\Qr Code (1).png" alt="QR Code" className="w-full h-full" />
//               </div>
            
//               <div className="flex flex-col gap-2">
//                 <img src="/assets/home-assets/google-play.png" alt="Google Play" className="w-[120px] h-auto" />
//                 <img src="/assets/home-assets/appstore.png" alt="App Store" className="w-[120px] h-auto" />
//               </div>
//             </div>

//             <div className="flex gap-4 pt-4">
//               <img src="src\assets\Icon-Facebook.png" alt="Facebook" className="w-6 h-6" />
//               <img src="src/assets/Vector.png" alt="Twitter" className="w-6 h-6" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-10">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              ...
              <div className="flex flex-col gap-2">
                <img src="src\assets\imges\photo_2025-10-06_19-57-28.jpg" alt="Google Play" className="w-[120px] h-auto" />
                <img src="src\assets\imges\photo_2025-10-06_19-57-38.jpg" alt="App Store" className="w-[120px] h-auto" />
              </div>
            </div>
