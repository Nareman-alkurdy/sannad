    ...
    <Box my={6} sx={{ background: "#fff", borderRadius: 2, p: 4, boxShadow: 2 }}>
      ...
      >
        ...
        <Box display="flex" alignItems="center" gap={1}>
          <IconButton onClick={prevPage} sx={{ width: 36, height: 36, backgroundColor: "#fff", border: "1px solid #ccc", borderRadius: 2, "&:hover": { borderColor: "#f44336", color: "#f44336", transform: "scale(1.1)" } }}>
            <ArrowBackIosNew fontSize="small" />
          </IconButton>
          <IconButton onClick={nextPage} sx={{ width: 36, height: 36, backgroundColor: "#fff", border: "1px solid #ccc", borderRadius: 2, "&:hover": { borderColor: "#f44336", color: "#f44336", transform: "scale(1.1)" } }}>
