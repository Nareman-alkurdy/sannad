...
const Categories = () => {
  ...
  return (
    <section className="my-10 bg-white p-4 rounded-xl shadow-sm overflow-hidden">
      {/* العنوان */}
      ...
      <div className="relative min-h-[200px]">
        <AnimatePresence initial={false} custom={direction}>
          <motion.div
            ...
            animate="center"
            exit="exit"
            className="grid grid-cols-3 md:grid-cols-6 gap-6 absolute w-full"
          >
            {cats.map((c, i) => (
              <button
                key={i}
