...
const team = [
  { name: "Tom Cruise", role: "Founder & Chairman", img: "src/assets/imges/image 46.png" },
  { name: "Emma Watson", role: "Managing Director", img: "src/assets/imges/image 51 (1).png" },
  { name: "Will Smith", role: "Product Designer", img: "src/assets/imges/image 47.png" },
];
        ...
        {team.map((member, idx) => (
          ...
          >
            ...
            <div className="p-5 flex flex-col">
              <h3 className="font-semibold text-lg md:text-xl text-left">{member.name}</h3>
              <p className="text-gray-500 mb-4 text-left text-sm md:text-base">{member.role}</p>
