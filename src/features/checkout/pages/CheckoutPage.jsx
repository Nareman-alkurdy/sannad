...
const CheckoutPage = () => {
  ...
  <div className="flex items-center justify-between mb-2">
    ...
    <div className="flex gap-2 pr-1">
      <img src="src\assets\image 30.png" alt="Visa" className="w-6 h-4" />
      <img src="src\assets\image 31.png" alt="MasterCard" className="w-6 h-4" />
      <img src="src\assets\image 32.png" alt="PayPal" className="w-6 h-4" />
      <img src="src\assets\image 33.png" alt="PayPal" className="w-6 h-4" />
    </div>
  </div>
